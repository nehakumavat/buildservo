				...
				<div class="col-md-3 col-sm-6">
					<div class="featured-box featured-box-primary featured-box-effect-1 mt-xlg">
						<div class="box-content">
							...
							<p><a href="<?php echo base_url();?>service-details" class="lnk-primary learn-more">Learn More <i class="fa fa-angle-right"></i></a></p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="featured-box featured-box-secondary featured-box-effect-1 mt-xlg">
						<div class="box-content">
							...
							<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus.</p>
							<p><a href="<?php echo base_url();?>service-details" class="lnk-secondary learn-more">Learn more <i class="fa fa-angle-right"></i></a></p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="featured-box featured-box-tertiary featured-box-effect-1 mt-xlg">
						<div class="box-content">
							...
							<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus.</p>
							<p><a href="<?php echo base_url();?>service-details" class="lnk-tertiary learn-more">Learn more <i class="fa fa-angle-right"></i></a></p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
