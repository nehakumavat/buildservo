            ...
            <ul>
                <li data-transition="fade">
                    ...
                    <a class="tp-caption btn btn-lg btn-primary btn-slider-action"
                       ...
                       data-transform_out="opacity:0;s:500;"
                       style="z-index: 5"
                       data-mask_in="x:0px;y:0px;">Sign In!</a>
    ...
    <!-- <div class="home-intro home-intro-primary" id="home-intro">
            <div class="container">
                    ...
                    <div class="row">
                            <div class="col-md-8">
                                    <p>
                                            The fastest way to grow your business with the leader in <em class="text-light">Technology</em>
                                            <span class="text-light">Check out our options and features included.</span>
                                    </p>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[0]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[0]['description']?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[1]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[1]['description']?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[2]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[2]['description']?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-md">
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[3]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[3]['description']?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[4]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[4]['description']?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[5]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[5]['description']?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-md mb-xl">
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="600">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[6]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[6]['description']?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="600">
                    ...
                    <div class="feature-box-info">
                        <h4 class="mb-sm"><?= $service_list[7]['name']?></h4>
                        <p class="mb-lg"><?= $service_list[7]['description']?></p>
                    </div>
                </div>
            </div>
<!--            <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div class="testimonial testimonial-style-2 testimonial-with-quotes mb-none">
                                        <div class="testimonial-author">
                                            <img src="<?php echo base_url(); ?>assets/frontend/img/clients/client-1.jpg" class="img-responsive img-circle" alt="">
                                        </div>
                                        <blockquote>
                                            <p><?= $fl['comment']?></p>
                                        </blockquote>
                                        <div class="testimonial-author">
                                            <p><strong><?= $fl['customer_name']?></strong><span>CEO & Founder - Okler</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
