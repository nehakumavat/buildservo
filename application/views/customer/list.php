                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            ?>
                                        <tr class="gradeX" id="employee-<?= $value['customer_profile_id'] ?>">
                                            <td><?= $value['customer_name']; ?></td>
                                            <td><?= $value['customer_email']; ?></td>
                                            <td><?= $value['customer_mob']; ?></td>
                                            <td class="center"><?= $value['customer_address']; ?></td>
                                            <td class="center"><?= $value['customer_city']; ?></td>
                                            <td class="center"><?= $value['customer_pincode']; ?></td>
                                            <td class="center"><?= $value['created_at']; ?></td>
                                            <td>
<!--                                                <a href="<?= base_url()?>customer/edit?id=<?= $value['id'] ?>"  class="btn btn-primary" data-id="<?= $value['id'] ?>" name="edit_employee">Edit</a>-->
                                                <a href="<?= base_url()?>customer/delete?id=<?= $value['customer_profile_id'] ?>" class="btn btn-danger delete-customer" data-index="<?= $value['customer_profile_id'] ?>" name="delete-customer">Delete</a><br>
                                            </td>
                                        </tr>
                                        <?php
                                    }
