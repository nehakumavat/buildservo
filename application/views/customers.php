            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    if (!empty($customers)) 
                    {
                        ...
                        {
                            ?>
                                <tr class="gradeX" id="customer-<?=$value->customer_id?>">
                                    <td><?=$value->customer_name;?></td>
                                    <td><?=$value->customer_email;?></td>
                                    <td><?=$value->customer_phone;?></td>
                                    <td class="center"><?=$value->customer_address;?></td>
                                    <td class="center"><?=$value->group_name;?></td>
                                    <td>
                                        <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#edit-customer"  data-id="<?=$value->customer_id?>" name="edit_customer" id="edit_customer">Edit</a>
                                        <a href="javascript:{}" class="btn btn-danger delete-customer" data-index="<?=$value->customer_id?>" name="delete-customer">Delete</a><br></td>
                                </tr>
                            <?php
                        }
                    }
