<div class="footer">
                    ...
                    <div>
                        <strong>Copyright</strong> Mavericks Infotech &copy; 2018
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url();?>assets/backend/js/plugins/select2/select2.full.min.js"></script>
    <!-- Data table -->
    <script src="<?php echo base_url();?>assets/backend/js/plugins/jeditable/jquery.jeditable.js"></script>
